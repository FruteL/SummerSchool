...
//    }
    ...
    public List<Role> getByPerformanceId(String id){
        return repository.findAll().stream().filter(role->role.getPerformance().getId().equals(id)).collect(Collectors.toList());
    }
}
